        ...
        <div className='portfolio-cards overflow-x-auto flex gap-4 p-4 lg:gap-0'>
            {
                portfolio.map((project, index) => (
                    <div 
                        className={`portfolio-card min-w-[80%] flex-shrink-0 flex flex-col gap-4 border-[1px] border-[#626262] rounded-lg p-4 align-center transition-all duration-500 justify-between 
                    ...
                    >
                        ...
                        <a className={`project-title ${activeIndex === index ? 'lg:mt-0' : 'lg:mt-4'}`} 
                            href={project.link} 
                            target="_blank" 
                            rel="noreferrer" 
                        ...
                        >
                            ...
                            <FontAwesomeIcon 
                                className={`link-arrow ${activeIndex === index && anchorHover && "bouncing-icon"}`} 
                                icon={faArrowRight} 
                                size="sm" 
                            />
                        </a>
                        <p 
                            className={`project-description mx-auto absolute overflow-hidden transition-all duration-500 
                                ${activeIndex === index ? 
                        ...
                        <div 
                            className={`portfolio-technologies flex space-between absolute overflow-hidden transition-all duration-500 
                                ${activeIndex === index ? 
                                    'lg:h-auto lg:relative lg:opacity-100' : 
                                    'lg:opacity-0 lg:h-0'
                                }`
